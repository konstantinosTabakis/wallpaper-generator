...
var applyStyleFromOptions_1 = require("./applyStyleFromOptions");
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, cloneNode_1.cloneNode)(node, options, true)];
                case 1:
                    clonedNode = (_b.sent());
                    return [4 /*yield*/, (0, embedWebFonts_1.embedWebFonts)(clonedNode, options)];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, (0, embedImages_1.embedImages)(clonedNode, options)];
                case 3:
                    _b.sent();
                    (0, applyStyleFromOptions_1.applyStyleFromOptions)(clonedNode, options);
